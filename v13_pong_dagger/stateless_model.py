...
class StatelessAgent:
  ...
  def __init__(self, name, state_dim, action_dim, xform, xform_action, actions):
    ...
    with self.session.graph.as_default():
      ...
      self.hidden_state = tf.layers.dense(self.input_state, 4, activation= tf.nn.relu)
...
#    if haha == 2: return 3
    ...
    print "xform state , action prob 0 2 3", xform_state, the_action
